...
def cosine_similarity(vector1: list, vector2: list) -> float:
    ...
    # vector1_mask = [1 if number != 0 else 0.3 for number in vector1]
    # vector2 = list(np.array(vector1_mask)*np.array(vector2))
